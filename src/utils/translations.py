...
UI_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'en': {
        ...
        'advisory_tab': 'Treatment Advisory',
        'upload_image_for_advice': 'Upload an image to get disease-specific advice',
    ...
    'hi': {
        ...
        'prediction_tab': 'भविष्यवाणी',
        'advisory_tab': 'उपचार सलाह',
        'upload_image_for_advice': 'रोग-विशिष्ट सलाह प्राप्त करने के लिए एक छवि अपलोड करें',
    ...
    'mr': {
        ...
        'loading': 'लोड होत आहे...',
        'error': 'त्रुटी',
        'no_image': 'कृपया प्रथम एक प्रतिमा अपलोड करा.',
        'prediction_tab': 'अंदाज',
        'advisory_tab': 'उपचार सल्ला',
        'upload_image_for_advice': 'विशिष्ट आजारांसाठी सल्ला मिळविण्यासाठी प्रतिमा अपलोड करा',
        'prediction_error': 'अंदाज देताना त्रुटी',
        'symptoms': 'लक्षणे',
        'prevention': 'प्रतिबंध',
